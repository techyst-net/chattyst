...
export const documentsList = [
  {
    ...
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | Chatyst Desk',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in Chatyst Desk.',
    created_at: 1736143273,
    external_link:
      'https://chatyst.techyst.net',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | Chatyst Desk',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    external_link:
      'https://chatyst.techyst.net',
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | Chatyst Desk',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    external_link:
      'https://chatyst.techyst.net',
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | Chatyst Desk',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in Chatyst Desk.',
    created_at: 1736143276,
    external_link:
      'https://chatyst.techyst.net',
    id: 3063,
    name: 'Managing Tickets | User Guide | Chatyst Desk',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    external_link:
      'https://chatyst.techyst.net',
    id: 3064,
    name: 'Financial Reporting | User Guide | Chatyst Desk',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Chatyst Desk deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Chatyst Desk' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with Chatyst Desk?',
    assistant: {
      account_id: 2,
      config: { product_name: 'Chatyst Desk' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Chatyst Desk?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Chatyst Desk' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Chatyst Desk?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Chatyst Desk' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Chatyst Desk?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Chatyst Desk' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Chatyst Desk allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Chatyst Desk?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Chatyst Desk' },

...
describe('useDetectedChannels', () => {
  describe('displayedChannels', () => {
    ...
    it('hides Meta channels on Chatyst Desk Cloud during the Meta restriction', () => {
      const { displayedChannels } = mountComposable({
        features: {
    ...
    it('keeps disabled TikTok in the secondary channel catalog on Chatyst Desk Cloud', () => {
